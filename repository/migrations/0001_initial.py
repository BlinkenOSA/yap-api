    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso_639_1', models.CharField(blank=True, max_length=2, null=True, verbose_name='ISO 639-1')),
                ('iso_639_2', models.CharField(blank=True, max_length=3, null=True, verbose_name='ISO 639-2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('creator', models.CharField(max_length=300, verbose_name='Creator')),
